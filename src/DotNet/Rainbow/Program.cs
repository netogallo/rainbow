...
namespace Rainbow
{
    ...
    /// </summary>
    /// <remarks>
    /// Built with .NET Core. Use this API reference: https://docs.microsoft.com/en-us/dotnet/core/api/index
    /// </remarks>
    public sealed partial class Program
    {
        public static void Initialize(int width, int height)
        {
            ...
            SceneNode.RootNode.AddChild(background.SpriteBatch);
            SceneNode.RootNode.AddChild(player.SpriteBatch);
